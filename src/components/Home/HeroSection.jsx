  ...
  return (
    ...
    >
      ...
      >
        <div>
          {/* dark:text-[#1D1E25] */}
          <h1 className="text-3xl sm:text-4xl md:text-[42px] font-extrabold text-gray-800 dark:text-white mb-6 lg:leading-snug flex items-center flex-wrap gap-2">
  Edge is Future; So is
  <span className="flex flex-col items-center ml-2">
    <span className="text-3xl font-rokkitt font-semibold xl:text-5xl text-[#ffcc00] leading-tight">
      <span>Log</span>
      <span className="text-[#0071c1]">ii</span>
      <span>cdev</span>
    </span>
    <p className="text-xs text-[#0071c1] font-medium -mt-1">
