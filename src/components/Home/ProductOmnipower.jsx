...
import {FaMicrochip, FaDollarSign, FaVolumeDown, FaBolt} from "react-icons/fa"
	...
	return (
		...
		>
			...
			>
				...
				>
					"OmniPower (OP) – The Future of Power Testing"
				</motion.h1>
				<p className="text-gray-700 mb-6 dark:text-[#E2E8F0]">
