				...
				>
					...
					<div className="flex flex-col lg:gap-3 lg:mt-8">
						<p className="dark:text-gray-300 text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
							We are continuously seeking partners for research projects.
							Collaborating leads to enhanced knowledge and understanding of
							technology.
						</p>
						<p className="dark:text-gray-300 text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
							Our areas of interest include Power Electronics, GaN, Battery,
							Digital Twins, AI, Robotics, Smart Transportation, HPC, and Cyber
							Security.
						</p>
						<p className=" dark:text-gray-300 text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
